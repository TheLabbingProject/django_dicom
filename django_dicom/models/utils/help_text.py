...
MANUFACTURER = "Manufacturer of the equipment that produced the composite instances"
...
SEQUENCE_NAME = (
    "User defined name for the combination of Scanning Sequence and Sequence Variant."
)
