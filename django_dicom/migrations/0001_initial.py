...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=4), size=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warnings', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True, null=True), blank=True, null=True, size=None)),
            ],
            options={
                'ordering': ['index'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dcm', models.FileField(max_length=1000, upload_to='dicom', validators=[django_dicom.models.utils.validators.validate_file_extension], verbose_name='File Path')),
                ('uid', models.CharField(max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^\\d+(\\.\\d+)*$', code='invalid_uid', message='Digits and dots only!')], verbose_name='SOP Instance UID')),
                ('number', models.IntegerField(null=True, verbose_name='Instance Number')),
                ('date', models.DateField(blank=True, null=True, verbose_name='Instance Creation Date')),
                ('time', models.TimeField(blank=True, null=True, verbose_name='Instance Creation Time')),
                ('warnings', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), blank=True, default=list, null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('uid', models.CharField(help_text='Unique identifier of the series', max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^\\d+(\\.\\d+)*$', code='invalid_uid', message='Digits and dots only!')], verbose_name='Series Instance UID')),
                ...
                ('scanning_sequence', django_dicom.models.utils.fields.ChoiceArrayField(base_field=models.CharField(choices=[('SE', 'Spin Echo'), ('IR', 'Inversion Recovery'), ('GR', 'Gradient Recalled'), ('EP', 'Echo Planar'), ('RM', 'Research Mode')], max_length=2), blank=True, help_text='Description of the type of data taken', null=True, size=5)),
                ('sequence_variant', django_dicom.models.utils.fields.ChoiceArrayField(base_field=models.CharField(choices=[('SK', 'Segmented k-Space'), ('MTC', 'Magnetization Transfer Contrast'), ('SS', 'Steady State'), ('TRSS', 'Time Reversed Steady State'), ('SP', 'Spoiled'), ('MP', 'MAG Prepared'), ('OSP', 'Oversampling Phase'), ('NONE', 'None')], max_length=4), blank=True, help_text='Variant of the scanning sequence', null=True, size=6)),
                ...
                ('operators_name', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='Name(s) of the operator(s) supporting the Series.', null=True)),
                ...
                ('mr_acquisition_type', models.CharField(blank=True, choices=[('2D', '2D'), ('3D', '3D')], help_text='Identification of data encoding scheme', max_length=2, null=True, verbose_name='MR Acquisition Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('uid', models.CharField(max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^\\d+(\\.\\d+)*$', code='invalid_uid', message='Digits and dots only!')], verbose_name='Study Instance UID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.FloatField(blank=True, null=True, verbose_name='Age in years')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw', models.CharField(blank=True, help_text='YYYYMMDD', max_length=8, null=True)),
            ],
            bases=('django_dicom.dataelementvalue',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('dataelementvalue_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_dicom.DataElementValue')),
                ('value', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(-2147483648), django.core.validators.MaxValueValidator(2147483647)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw', models.CharField(blank=True, help_text='HHMMSS.FFFFFF', max_length=16, null=True)),
            ],
            bases=('django_dicom.dataelementvalue',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('dataelementvalue_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_dicom.DataElementValue')),
                ('value', models.CharField(blank=True, max_length=64, null=True, validators=[django.core.validators.RegexValidator('^\\d+(\\.\\d+)*$', code='invalid_uid', message='Digits and dots only!')])),
                ('raw', models.CharField(blank=True, max_length=64, null=True)),
            ],
            bases=('django_dicom.dataelementvalue',),
        ),
        ...
        migrations.AddField(
            model_name='dataelement',
            name='header',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data_element_set', to='django_dicom.Header'),
        ),
        migrations.AddIndex(
            model_name='series',
