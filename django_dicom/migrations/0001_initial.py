# Generated by Django 2.2 on 2019-04-22 12:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dcm', models.FileField(upload_to='dicom', validators=[django_dicom.models.validators.validate_file_extension])),
                ('uid', models.CharField(max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^\\d+(\\.\\d+)*$', code='invalid_uid', message='Digits and dots only!')], verbose_name='Instance UID')),
