# Generated by Django 2.1.3 on 2018-11-23 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('patient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dicomdj.Patient')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='series',
            name='study',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dicomdj.Study'),
        ),
        migrations.AddField(
            model_name='instance',
            name='patient',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dicomdj.Patient'),
        ),
        migrations.AddField(
            model_name='instance',
            name='series',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dicomdj.Series'),
        ),
        migrations.AddField(
            model_name='instance',
            name='study',
